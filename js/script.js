...
function openDesc(theid) {
  ...
  if (x.style.classList.contains('closed')) {x.style.classList.add('opened');x.style.classList.remove('closed);}
  else {x.style.classList.add('closed');x.style.classList.remove('opened);}}
